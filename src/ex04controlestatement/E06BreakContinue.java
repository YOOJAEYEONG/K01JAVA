...
/*
break문
	: 반복문이나 switch 문에서 주로 사용되며 블럭내에서
	break문을 만나게되면 해당 블럭을 탈출한다.
	만약 중첩된 반복문이라면 가장 가까운 블럭 하나만 탈출하게 된다.
continue 문
	: 반복문에서 continue 문을 만나게 되면 블럭의 처음으로 돌아가서 조건을 확인한다.
	따라서 continue 아래문장은 실행되지 않기 때문에 if와함께 조건부로 사용한다.
...
public class E06BreakContinue {
	...
	public static void main(String[] args) {
		...
		/*
		중첩된 반복문 안에서 break문을 만나면 
		'가장가까운 반복문 하나'를 탈출하게 된다.
		 */
		for(int x=1; x<=5; x++) {
