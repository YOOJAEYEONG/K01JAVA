...
public class E02SoBigNumberClass {
	...
	public static void main(String[] args) {
		...
		/*
		BigInteger
			: int형이나 long형으로 표현할 수 없는 범위의 큰수를 연산할 때 사용된다.
			인자로 전달할때 반드시 문자열형태로 기술해야한다.
		 */
//		long lngNum = 100000000000;//코드 작성 불가
		...
		/*
		BigDecimal 클래스
			: 실수의 오차 없는 표현이나 연산을 위해 사용하는 클래스
		 */
		double dbl1 = 1.6;
		double dbl2 = 0.1;

		System.out.println("두 실 수의 덧셈 결과 (오차있음)" +dbl1+dbl2);
		System.out.println("두 실 수의 곱셈 결과 (오차있음)" +dbl1*dbl2);
