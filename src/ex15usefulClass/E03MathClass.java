...
import java.lang.*;//* : 아스테리크; lang 패키지안의 모든 클래스를 의미
...
public class E03MathClass{
	...
	public static void main(String[] args) {
		...
		/*
		반올림 : 무조건 소수점 첫번째 자리에서 반올림 처리한다.
		 */
		System.out.println("### 반올림 ###");
		System.out.println("Math.round : " + Math.round(3.49999));//3.0 소수점 첫번째자리만 보고 판단하기 때문
		System.out.println("Math.round : " + Math.round(3.54444));//4.0
		...
		System.out.println("2의 10승은? : " + Math.pow(2,10));//double 타입 반환
