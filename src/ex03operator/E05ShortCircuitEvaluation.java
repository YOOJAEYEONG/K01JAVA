...
public class E05ShortCircuitEvaluation {
	...
	public static void main(String[] args) {
		 ...
		 * 	변경되는 코드가 있다면 실행되지 않으므로 주의 해야한다.
		 */
		int num1 = 0, num2 = 0;
		boolean result;
		...
		/*
		 * ||(논리Or)의 경우 둘중 하나만 true이면 true를 반환하므로 첫번째 조건이
		 *  true이면 두번째 조건을 검사하지 않는다.
		 */
		result = (num1+=10)>0 || (num2+=10)>0;
		...
		/*
		 * 따라서 num2의 결과가 프로그램에 영향을 미치게되는 경우라면 별도의
		 * 처리를 해야하고 코드작성에 주의해야한다.
		 */
	}
