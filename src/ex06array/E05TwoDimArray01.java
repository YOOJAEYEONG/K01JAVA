...
public class E05TwoDimArray01 {
	...
	public static void main(String[] args) {
		 ...
		 * 설정된다. 초기화할 요소가 없는 부분은 null로 채워진다.
		 * null값 : 아무것도 없는 값을 말한다. 즉 빈 값을 말한다.
		 * 	스페이스같은 공백문자와는 다르다는 것에 주의하자.
		 */
		...
		//2차원 배열에서 "배열명.length"로 출력하면 세로(행)크기가 반환된다.
		...
		/*
		 *  java.lang.ArrayIndexOutOfBoundsException 예외발생됨
		 *  즉, 배열의 index를 초과했다는뜻.
		 */
	}
