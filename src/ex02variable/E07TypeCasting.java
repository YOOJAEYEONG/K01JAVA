...
public class E07TypeCasting {
	...
	public static void main(String[] args) {
		...
		*/
		...
		연산을 진행하며, 결과도 int로 반환하다. cpu의 특성이라 생각하자
		 */
		int num1 = b1 + s1;
		int num2 = num1;
...
//		char ch1 = b1;//[에러발생]
		...
		/*
		명시적 형변환 : 큰상자의 자료를 작은상자의 자료형에 할당해야할때 사용한다.
		단, 이때는 데이터의 손실이 있을수 있으므로 주의를 요한다.
		 */
		short s2 = 100;
		byte b2 = (byte)s2;
		...
		/*
		소수점 아래부분이 버려지므로 데이터 손실됨. 따라서 특수한 경우가 아니라면
		사용을 자제하는것이 좋다.
		 */
		int num3;
		double d1 = 3.14;
