...
public class AnimalDog extends Animal{
	...
	public void bark() {
		System.out.printf("이름이 %s 이고 종(%s)이 %s인 강아지가 짖는다.", name, dogKind, super.getSpecies());
	}
	
	public void showDog() {
//		showAnimal();//에러는 안나지만 super를 붙여주면 명시적으로 부모클래스에서 받아온것임을 파악하는데 용이하다
		super.showAnimal();
		System.out.println("종류은 : "+ dogKind);
