...
//	오버라이딩이 아니다!!!
//	부모클래스에서 private멤버 메소드로 선언되었기 때문에 
...
//	해당 함수는 자식에서 새롭게 확장한 메소드가 된다.
	...
	/*
	메소드 오버라이딩의 조건
	- 부모클래스에서 선언될때와 비교해서 접근범위가 동일하거나 그보다 넓으면 가능.
	- 즉, 부모에서 default일때 자식쪽에서 default, public이면 오버라이딩이 가능.
	*/
	@Override
	public String sleep() {
...
//	메소드의 형태가 부모메소드와 다르므로 오버라이딩이 아닌 오버로딩의형태로
//	자식에서 확장한 메소드가 된다.
...
//	오버라이딩 정의
	 ...
	 * super.멤버 : 부모클래스에 정의된 멤버변수 혹은 멤버메소드 호출
	 */
